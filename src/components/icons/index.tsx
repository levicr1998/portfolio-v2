import BackIcon from './back-icon.svg?react';
import CompanyIcon from './company-icon.svg?react';
...
export { BackIcon, CompanyIcon, SendIcon, FacebookIcon, GithubIcon, InstagramIcon, LinkedInIcon };
